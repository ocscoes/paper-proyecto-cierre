...
1) Los datos abiertos del Banco Mundial. Contiene diversos indicadores sobre desarrollo social y económico de la mayoría de los países del mundo. El portal de datos es accesible en: [https://datos.bancomundial.org/](https://datos.bancomundial.org/).
...
En cuanto a factores institucionales, se consideró el Índice de Democracia Electoral, o poliarquía, para medir la **Calidad democrática de los países**. Por otro lado, se incluyó **un índice de gobernanza** ($\alpha$ = 0.96)  calculado a partir de los *Worldwide Governace Indicators* del Banco Mundial [@kaufmann_worldwide_2024].
